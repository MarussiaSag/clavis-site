  ...
  if (layout === "home") {
    return (
      <Link href={`/blog/${post.slug}`} className="group block">
        <article className="overflow-hidden rounded-md border border-[#3a3a3a] transition-colors duration-300 group-hover:border-[#f1ece7]/50">
          ...
          <div className="bg-[#1a1a1a] px-5 py-5 transition-colors duration-300 group-hover:bg-white md:px-6 md:py-6">
  ...
  return (
    <Link href={`/blog/${post.slug}`} className="group block">
      <article className="space-y-4">
        <div className="relative aspect-[16/10] overflow-hidden rounded-md bg-[#2a2a2a]">
          <div
